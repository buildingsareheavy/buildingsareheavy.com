...
export default {
  ...
  prismJS() {
        ...
        /* PrismJS 1.17.1
  https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript+bash+markup-templating+graphql+php+markdown+json+typescript+scss&plugins=line-highlight+line-numbers+toolbar+show-language+copy-to-clipboard */
                    ...
                    if (!(k instanceof L)) {
                      ...
                      if (O) {
                        ...
                        if (
                          ...
                          1 != S &&
                            _.matchGrammar(e, r, n, y, v, !0, l + ',' + u),
                          i)
                        )
                          break;
                      } else if (i) break;
